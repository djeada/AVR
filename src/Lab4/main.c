...
int arr[10] = {0b11000000, 0b11111001, 0b10100100, 0b10110000, 0b10011011,
...
int main() {
  ...
  OCR1A = 10;
  // rejestr kontrolny, ustawiamy tryb pracy by utrzymac clk I/O /1024 (From
  // prescaler
  TCCR1B |= (1 << WGM12);
  TCCR1B |= (1 << CS12);
  TCCR1B |= (1 << CS10);
